...
public class ServiceConstants {
    ...
    public static final String MESSAGE_BODY = "your application with application number %s is approved";
    public static final String MOBILE_NUMBER = "mobileNumber";
    public static final String MESSAGE = "message";
    public static final String BUSINESS_SERVICE_CODE_ADVOCATE = "AD";
    public static final String BUSINESS_SERVICE_CODE_ADVOCATE_CLERK = "ADCL";
    public static final String WORKFLOW_MODULE_NAME = "create-advocates";
    public static final String FILE_UPLOAD_FAILED = "File upload failed: ";
    public static final String NO_FILE_DATA = "File upload returned no file data for file: ";
